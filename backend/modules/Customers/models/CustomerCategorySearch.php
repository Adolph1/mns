...
use backend\modules\customers\models\CustomerCategory;

/**
 * CustomerCategorySearch represents the model behind the search form about `backend\modules\customers\models\CustomerCategory`.
 */
